...
public class ListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			HttpGet httpget = new HttpGet("http://1.zouxuan2.sinaapp.com/filelist.php");// IP为自己的服务器的IP因为手机连接局域网的WIFI，所以只用自己的电脑作为服务器也可以测试效果。
	...
	private void setupViews() {
		...
		adapter = new MyAdapter(imagelist,namelist,timelist,datalist, count, this);// 这里把从数据库读取出来的图片URL传给Adapter
